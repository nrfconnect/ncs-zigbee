...
#define ZIGBEE_SETTINGS_KEY_MATTER_PROTOCOL_STATE "pt"
...
#define ZIGBEE_SETTINGS_FULL_NAME_MATTER_PROTOCOL_STATE \
	ZIGBEE_SETTINGS_SUBSYS_NAME "/" ZIGBEE_SETTINGS_KEY_MATTER_PROTOCOL_STATE
