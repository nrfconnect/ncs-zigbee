...
nRF Connect SDK - Zigbee R23 add-on
###################################
...
In combination with the integrated Zephyr RTOS, Zigbee in the |NCS| allows for development of low-power connected solutions.
