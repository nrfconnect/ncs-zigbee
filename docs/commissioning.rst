...
.. note::
   ...
   In the |addon| for the |NCS|, it is provided as an experimental feature with basic functionality through the ``CONFIG_ZIGBEE_TOUCHLINK_INITIATOR`` and ``CONFIG_ZIGBEE_TOUCHLINK_TARGET`` Kconfig options.
